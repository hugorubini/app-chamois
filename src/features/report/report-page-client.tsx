...
import type {
  ...
  ObservationAgeClass,
  ObservationBehavior,
  ObservationBodyCondition,
  ObservationCertainty,
  ObservationDisturbance,
  ObservationHasKid,
  ObservationSex,
  ObservationType,
...
export default function ReportPageClient() {
  ...
  const [sex, setSex] = useState<ObservationSex>("unknown");
  const [ageClass, setAgeClass] = useState<ObservationAgeClass>("unknown");
  const [hasKid, setHasKid] = useState<ObservationHasKid>("unknown");
  const [bodyCondition, setBodyCondition] =
    useState<ObservationBodyCondition>("unknown");
  const [disturbance, setDisturbance] =
    useState<ObservationDisturbance>("unknown");
  ...
  useEffect(() => {
    ...
    setSex(existingObservation.sex ?? "unknown");
    setAgeClass(existingObservation.ageClass ?? "unknown");
    setHasKid(existingObservation.hasKid ?? "unknown");
    setBodyCondition(existingObservation.bodyCondition ?? "unknown");
    setDisturbance(existingObservation.disturbance ?? "unknown");
    setHealthComment(existingObservation.healthComment ?? "");
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const trimmedHealthComment = healthComment.trim();
    ...
    const observation: Observation = {
      ...
      bodyCondition,
      disturbance,
      healthComment: trimmedHealthComment,
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    value={sex}
                    onChange={(e) =>
                      setSex(e.target.value as ObservationSex)
                    }
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  >
                ...
                <div>
                  ...
                  <select
                    value={ageClass}
                    onChange={(e) =>
                      setAgeClass(e.target.value as ObservationAgeClass)
                    }
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  >
                ...
                <div>
                  ...
                  <select
                    value={hasKid}
                    onChange={(e) =>
                      setHasKid(e.target.value as ObservationHasKid)
                    }
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  >
                    <option value="unknown">Indéterminée</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setBodyCondition(
                        e.target.value as ObservationBodyCondition
                      )
                    }
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setDisturbance(
                        e.target.value as ObservationDisturbance
                      )
                    }
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Plaie, parasites, toux, boiterie, comportement anormal..."
                    rows={4}
                    className="block w-full min-w-0 max-w-full rounded-xl border border-neutral-300 px-3 py-3 text-base box-border"
                  />
                </div>
